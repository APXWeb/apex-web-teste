...
FIRST VIEWPORT: duas colunas iguais. À esquerda, headline em duas linhas ("Sites que trabalham / pelo seu negócio."), uma frase de posicionamento, a ação principal compacta (WhatsApp, via compositor de contato) com um link de texto para os trabalhos e, abaixo, a linha de agenda aberta. À direita, a vitrine: moldura de navegador com a interface real de um projeto, celular sobreposto na borda direita e, abaixo, o índice dos seis projetos em grade 3×2 (nome, ponto de status e tipo), com barra de progresso na aba ativa. A legenda traz nome, natureza, pausa e "Ver case". A vitrine avança sozinha, pausa no hover/foco e troca ao passar o mouse sobre o índice. Tudo cabe em 1440×900. No mobile, a vitrine fica abaixo do texto e o índice vira faixa rolável.
